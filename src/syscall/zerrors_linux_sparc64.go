...
const (
	...
	EISDIR          = Errno(0x15)
	EISNAM          = Errno(0x78)
	EKEYEXPIRED     = Errno(0x81)
	EKEYREJECTED    = Errno(0x83)
	EKEYREVOKED     = Errno(0x82)
	EL2HLT          = Errno(0x65)
	EL2NSYNC        = Errno(0x5f)
	EL3HLT          = Errno(0x60)
	EL3RST          = Errno(0x61)
	...
	ELNRNG          = Errno(0x62)
	ELOOP           = Errno(0x3e)
	EMEDIUMTYPE     = Errno(0x7e)
	EMFILE          = Errno(0x18)
	EMLINK          = Errno(0x1f)
	EMSGSIZE        = Errno(0x28)
	EMULTIHOP       = Errno(0x57)
	...
	EOVERFLOW       = Errno(0x5c)
	EOWNERDEAD      = Errno(0x84)
	EPERM           = Errno(0x1)
